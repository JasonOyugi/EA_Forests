...
const defaultPlans: PricingPlan[] = [
  {
    id: 'starter',
    name: 'Site Starter',
    description: 'For new forestry projects and early-stage land review.',
    price: '$29',
    frequency: '/month',
    features: [
      'Land screening support',
      'Basic site and species modeling',
      'Project templates for planting and maintenance',
      'Email-based forestry support',
    ],
  },
  {
    id: 'professional',
    name: 'Managed Forest',
    description: 'For active forestry portfolios with ongoing execution.',
    price: '$99',
    frequency: '/month',
    features: [
      'Site monitoring and performance tracking',
      'Contractor and nursery coordination',
      'Yield and carbon tracking',
      'Market access guidance',
      'Advanced forest analytics',
    ],
    popular: true,
  },
  {
    ...
    description: 'For investors with multiple commercial forestry assets.',
    price: '$249',
    frequency: '/month',
    features: [
      'Dedicated forestry advisory',
      'Custom carbon and timber strategies',
      'Priority project support',
      'Tailored site and value-chain reporting',
